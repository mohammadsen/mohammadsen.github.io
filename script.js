...
function saveName() {
    ...
    // ❌ Empty input
    if (!name) {
        showNameError("Please enter your beautiful name 💌");
        return;
    }

    // ❌ Wrong name
    if (name.toLowerCase() !== "audrey") {
        showNameError("Only Audrey can continue 💔");
        shakeInput();
        return;
    }
    ...
    setTextSafe("displayName", userName);
    setTextSafe("finalName", userName);
    setTextSafe("heartName", userName);
...
function shakeInput() {
    ...
    if (!input || typeof gsap === "undefined") return;
...
function typeMessage() {
    const messages = [
        `Dear ${userName},`,
        "I wanted to wish you nothing but the best for your 25th Birthday",
        "I love you more than you can ever imagine",
        "You make me so happy.",
        "You are the most amazing, caring, kind, and beautiful girl in the whole entire world.",
        "I am so fortunate to be able to spend your special day with you.",
        "Here is to 100 more birthdays.",
